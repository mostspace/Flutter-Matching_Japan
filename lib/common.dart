...
const String API_URL = "http://192.168.144.61:8000/api/";
// ignore: constant_identifier_names
const String BASE_URL = "http://192.168.144.61:8000";
...
class BodyTypeObject {
  ...
  BodyTypeObject(this.id, this.title,  this.isChecked);
}

class PurposeTypeObject {
  int id;
  String title;
  bool isChecked;

  PurposeTypeObject(this.id, this.title,  this.isChecked);
}
