              ...
              child: Align(
                ...
                child: SizedBox(
                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                      padding: EdgeInsets.symmetric(horizontal: vw(context, 2)),
                      child: Align(
                        child: Row(
                          children: [
                            Expanded(
                              child: Wrap(
                                ...
                                children: List.generate(
                                  ...
                                  (index) {
                                    if (appCubit.communityList[index].parent !=
                                        -1) {
