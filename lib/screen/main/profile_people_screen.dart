...
class ProfilePeopleScreen extends ConsumerStatefulWidget {
  final String? info;

  const ProfilePeopleScreen({super.key, required this.info});

  @override
  // ignore: library_private_types_in_public_api
  ConsumerState<ProfilePeopleScreen> createState() => _ProfilePeopleScreenState();
}

class _ProfilePeopleScreenState extends ConsumerState<ProfilePeopleScreen> {
  List<dynamic> items = [];
