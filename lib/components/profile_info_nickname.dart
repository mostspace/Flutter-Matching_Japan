...
class ProfileInfoNickName extends StatelessWidget {
	final String title, value;

	final bool isShowWheel;
	final OnPressed onPressed;
  final List<dynamic>? list;
	const ProfileInfoNickName(
			{super.key,
			required this.title,
			required this.value,
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: WheelChooser.custom(
                          onValueChanged: (idx) { address = list![idx].address.toString(); idx = (list![idx].idx).toString();},
                      ...
                      ElevatedButton(
                        onPressed: () {
                          print(idx.toString());
                          appCubit.changeAddress(address, idx.toString());
